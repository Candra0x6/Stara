              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4 text-sm text-muted-foreground mb-3">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {job.closedAt
                      ? new Date(job.closedAt).toLocaleDateString('en-US', {
                        year: 'numeric',
                        month: 'short',
                        day: 'numeric'
                      })
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className={`rounded-full p-2 transition-colors ${saved ? "text-white bg-destructive border-none hover:bg-destructive" : "text-white"
                  }`}
