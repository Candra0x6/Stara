      ...
      <div className="relative h-full">
        ...
        <div className="p-6 h-full relative flex flex-col">
          <div className="space-y-2">
            <h3 className="text-2xl font-semibold tracking-tight [text-shadow:_0_1px_1px_rgb(0_0_0_/_10%)]">Models</h3>
  ...
  },
  {
    ...
    cardContent: (
      <div className="relative h-full">
        ...
        <div className="p-6 h-full relative flex flex-col">
          <div className="space-y-2">
            <h3 className="text-xl font-semibold tracking-tight [text-shadow:_0_1px_1px_rgb(0_0_0_/_10%)]">MCPs</h3>
            <p className="text-sm text-black/50 dark:text-white/50 leading-relaxed max-w-[90%]">
  ...
  },
  {
    ...
    cardContent: (
      <div className="relative h-full">
        ...
        <div className="p-6 h-full relative flex flex-col">
          <div className="space-y-2">
            <h3 className="text-2xl font-semibold tracking-tight [text-shadow:_0_1px_1px_rgb(0_0_0_/_10%)]">Agents</h3>
            <p className="text-sm text-black/50 dark:text-white/50 leading-relaxed max-w-[90%]">
  ...
  },
  {
    ...
    cardContent: (
      <div className="relative h-full">
        ...
        <div className="p-6 h-full relative flex flex-col">
          <div className="space-y-2">
            <h3 className="text-2xl font-semibold tracking-tight [text-shadow:_0_1px_1px_rgb(0_0_0_/_10%)]">Users</h3>
            <p className="text-sm text-black/50 dark:text-white/50 leading-relaxed max-w-[90%]">
...
export default function SmoothTab({
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Card Content Area */}
      <div className="flex-1 mb-4 relative mt-48">
        <div className="bg-card border rounded-lg h-[200px] w-1/2 mx-auto py-auto relative">
          <div className="absolute inset-0 overflow-hidden rounded-lg">
            <AnimatePresence initial={false} mode="popLayout" custom={direction}>
              ...
              >
                <Link href="https://kokonutui.com/" target="_blank">
